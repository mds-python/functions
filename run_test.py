...
class TestQuadratic(unittest.TestCase):
    ...
    def test_none(self):
        self.assertIsNone(functions.quadratic_equation(1, 1, 1))

    def test_linear(self):
        self.assertEqual(functions.quadratic_equation(0, 2, -6), 3)

    def test_linear_none(self):
        self.assertIsNone(functions.quadratic_equation(0, 0, 1))

    def test_linear_infinity(self):
        self.assertIsNone(functions.quadratic_equation(0, 0, 0))
...
class TestDice(unittest.TestCase):
    ...
    def test_histogram(self):
        ...
        self.assertEqual(500, sum(1 for c in result if c == '#'))
